...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="font-vazir py-24 px-4 relative bg-secondary/30">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                ...
                <div className="badge-base LI-profile-badge" data-locale="en_US" data-size="large" data-theme="dark" data-type="HORIZONTAL" data-vanity="mahan-mahmoudi-4a58a2278" data-version="v1"><a className="badge-base__link LI-simple-link" href="https://ir.linkedin.com/in/mahan-mahmoudi-4a58a2278?trk=profile-badge">mahan Mahmoudi</a></div>
